<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="remitos_detalles.aspx.cs" Inherits="Depositos_del_Oeste._RemitosDetalles" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div id="Imprimir">
        ...
        <br />
        <a runat="server" id="lnkimprimir" href="remitos_ver.aspx?id=" class="lnkver">
